...
def genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound, u_bound, fitness_function, K_ls, seed=None):
    if seed is not None:
        np.random.seed(seed)
...
for run in range(num_runs):
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound, u_bound, alluffi_pentiny, K_ls)
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_b1, u_bound_b1, bohachevsky_1, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_b2, u_bound_b2, bohachevsky_2, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_bl, u_bound_bl, becker_lago, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_b, u_bound_b, branin, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_c, u_bound_c, camel, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_c, u_bound_c, cb3, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_cm*np.ones(n), u_bound_cm*np.ones(n), cosine_mixture, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_dejong*np.ones(n_dejong), u_bound_dejong*np.ones(n_dejong), dejong, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_easom*np.ones(n_easom), u_bound_easom*np.ones(n_easom), easom, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential2), u_bound_exp*np.ones(n_exponential2), exponential, K_ls)
  # Store the function evaluations for this run
  ...
  # Run the genetic algorithm for Exponential function
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential4), u_bound_exp*np.ones(n_exponential4), exponential, K_ls)
  # Store the function evaluations for this run
  ...
  # Run the genetic algorithm for Exponential function
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential8), u_bound_exp*np.ones(n_exponential8), exponential, K_ls)
  # Store the function evaluations for this run
  ...
  # Run the genetic algorithm for Exponential function
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential16), u_bound_exp*np.ones(n_exponential16), exponential, K_ls)
  # Store the function evaluations for this run
  ...
  # Run the genetic algorithm for Exponential function
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential32), u_bound_exp*np.ones(n_exponential32), exponential, K_ls)
  # Store the function evaluations for this run
  ...
  # Run the genetic algorithm for Exponential function
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential64), u_bound_exp*np.ones(n_exponential64), exponential, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_gkls*np.ones(n_gkls2), u_bound_gkls*np.ones(n_gkls2), lambda x: gkls(x, n_gkls2, w_gkls), K_ls)
  # Store the function evaluations for this run
  ...
  # Run the genetic algorithm for Gkls function
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_gkls*np.ones(n_gkls3), u_bound_gkls*np.ones(n_gkls3), lambda x: gkls(x, n_gkls3, w_gkls), K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_gp*np.ones(2), u_bound_gp*np.ones(2), goldstein_price, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_griewank2*np.ones(2), u_bound_griewank2*np.ones(2), griewank2, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_hansen*np.ones(2), u_bound_hansen*np.ones(2), hansen, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_hartman3*np.ones(3), u_bound_hartman3*np.ones(3), hartman_3, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_hartman6*np.ones(6), u_bound_hartman6*np.ones(6), hartman_6, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_rastrigin*np.ones(2), u_bound_rastrigin*np.ones(2), rastrigin, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_rosenbrock*np.ones(n_rosenbrock), u_bound*np.ones(n_rosenbrock), rosenbrock, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_shekel5*np.ones(n_shekel5), u_bound_shekel5*np.ones(n_shekel5), shekel_5, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_shekel7*np.ones(n_shekel7), u_bound_shekel7*np.ones(n_shekel7), shekel_7, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_shekel10*np.ones(n_shekel10), u_bound_shekel10*np.ones(n_shekel10), shekel10, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_shubert*np.ones(2), u_bound_shubert*np.ones(2), shubert, K_ls)
  # Store the function evaluations for this run
  ...
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_potential3, u_bound_potential3, potential, K_ls)
  # Store the function evaluations for this run
  ...
  # Run the genetic algorithm for the Potential function
  best_solution, min_value, evaluations = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_potential5, u_bound_potential5, potential, K_ls)
  # Store the function evaluations for this run
