...
def genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound, u_bound, fitness_function):
    # Initialization
    dim = len(l_bound)
    ...
    while True:
        ...
        if np.abs(f_h - f_l) <= e or iter_count > ITERMAX:
            break
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound, u_bound, alluffi_pentiny)
# Print results
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_b1, u_bound_b1, bohachevsky_1)
# Print results
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_b2, u_bound_b2, bohachevsky_2)
# Print results
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_bl, u_bound_bl, becker_lago)
# Print results
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_b, u_bound_b, branin)
# Print results
print("Best Solution (Branin):", best_solution)
print("Minimum Value (Branin):", min_value)

# Run the genetic algorithm for Camel function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_c, u_bound_c, camel)
# Print results
print("Best Solution (Camel):", best_solution)
print("Minimum Value (Camel):", min_value)

# Run the genetic algorithm for Cb3 function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_c, u_bound_c, cb3)
# Print results
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_cm*np.ones(n), u_bound_cm*np.ones(n), cosine_mixture)
# Print results
print("Best Solution (CM):", best_solution)
print("Minimum Value (CM):", min_value)

# Run the genetic algorithm for DeJong function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_dejong*np.ones(n_dejong), u_bound_dejong*np.ones(n_dejong), dejong)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_easom*np.ones(n_easom), u_bound_easom*np.ones(n_easom), easom)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential2), u_bound_exp*np.ones(n_exponential2), exponential)
# Print results for Exponential function
print("Best Solution (EXP2):", best_solution)
print("Minimum Value (EXP2):", min_value)
# Run the genetic algorithm for Exponential function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential4), u_bound_exp*np.ones(n_exponential4), exponential)
# Print results for Exponential function
print("Best Solution (EXP4):", best_solution)
print("Minimum Value (EXP4):", min_value)
# Run the genetic algorithm for Exponential function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential8), u_bound_exp*np.ones(n_exponential8), exponential)
# Print results for Exponential function
print("Best Solution (EXP8):", best_solution)
print("Minimum Value (EXP8):", min_value)
# Run the genetic algorithm for Exponential function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential16), u_bound_exp*np.ones(n_exponential16), exponential)
# Print results for Exponential function
print("Best Solution (EXP16):", best_solution)
print("Minimum Value (EXP16):", min_value)
# Run the genetic algorithm for Exponential function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential32), u_bound_exp*np.ones(n_exponential32), exponential)
# Print results for Exponential function
print("Best Solution (EXP32):", best_solution)
print("Minimum Value (EXP32):", min_value)
# Run the genetic algorithm for Exponential function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_exp*np.ones(n_exponential64), u_bound_exp*np.ones(n_exponential64), exponential)
# Print results for Exponential function
print("Best Solution (EXP64):", best_solution)
print("Minimum Value (EXP64):", min_value)

# Run the genetic algorithm for Gkls function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_gkls*np.ones(n_gkls2), u_bound_gkls*np.ones(n_gkls2), lambda x: gkls(x, n_gkls2, w_gkls))
# Print results for Gkls function
print("Best Solution (GKLS250):", best_solution)
print("Minimum Value (GKLS250):", min_value)

# Run the genetic algorithm for Gkls function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_gkls*np.ones(n_gkls3), u_bound_gkls*np.ones(n_gkls3), lambda x: gkls(x, n_gkls3, w_gkls))
# Print results for Gkls function
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_gp*np.ones(2), u_bound_gp*np.ones(2), goldstein_price)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_griewank2*np.ones(2), u_bound_griewank2*np.ones(2), griewank2)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_hansen*np.ones(2), u_bound_hansen*np.ones(2), hansen)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_hartman3*np.ones(3), u_bound_hartman3*np.ones(3), hartman_3)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_hartman6*np.ones(6), u_bound_hartman6*np.ones(6), hartman_6)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_rastrigin*np.ones(2), u_bound_rastrigin*np.ones(2), rastrigin)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_rosenbrock*np.ones(n_rosenbrock), u_bound*np.ones(n_rosenbrock), rosenbrock)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_shekel5*np.ones(n_shekel5), u_bound_shekel5*np.ones(n_shekel5), shekel_5)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_shekel7*np.ones(n_shekel7), u_bound_shekel7*np.ones(n_shekel7), shekel_7)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_shekel10*np.ones(n_shekel10), u_bound_shekel10*np.ones(n_shekel10), shekel10)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_shubert*np.ones(2), u_bound_shubert*np.ones(2), shubert)
...
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_potential3, u_bound_potential3, potential)
...
# Run the genetic algorithm for the Potential function
best_solution, min_value = genetic_algorithm(N, ITERMAX, p_m, b, e, l_bound_potential5, u_bound_potential5, potential)
# Print results for Potential function
